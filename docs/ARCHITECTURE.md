...
| `lib/fast-summary.mjs` | 394 | The non-LLM session summary — one shape, three callers. Audit 2026-08-22 P2-9. hook.mjs carried three hand-copied versions of "read this session's… | FAST_SUMMARY_LIMITS, readFastSummarySource(), insertFastSummary(), parseSummaryNotes(), formatSummaryNotes(), newestSummaryId(), writeStopSummary() … (+2) |
