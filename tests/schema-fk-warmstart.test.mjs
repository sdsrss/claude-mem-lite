...
// the same failure class the v28 orphan cleanup (schema.mjs) patched
...
// leaked while FK was OFF (live DB: 6440/9569 observation_files)
// stays until cleaned. A one-shot cleanup, gated to the full migration path by a
// version bump, mirrors the existing v28 orphan cleanup (schema.mjs).
