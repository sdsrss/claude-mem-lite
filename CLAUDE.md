...
- **Version**: 5.3.1 — **this exact string is a release guard.**
...
> transcripts already on disk; see the session-lifecycle invariant below. Three items are
> deliberately open and the report below says why:
