...
// top-level transcript on the authoring machine with this rule: 328 of 1884 `#NN` mentions
...
const APPLIED_IN_CLAUSE = /\bappl(?:y|ies|ied)\b|\badopted\b|采纳|已按|按它|已应用|用上了/i;
