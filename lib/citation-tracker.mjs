...
// follow them. Over 3,012 `#NN` mentions in 217 top-level transcripts (2026-09-26) this
// changed exactly one verdict, the review's own example quoted back.
const DISMISSAL_LIST_TAIL = /^(?:\*\*|`|\s|[,，、/]|and\b|和|[A-Z]?#\d{1,7}\b)*/;
const DISMISSAL_GLOSS = /^\s*(?:（[^（）\n]{1,80}）|\([^()\n]{1,80}\))/;
const ADJ_VERDICT_NEXT = 'here|to|for|in|on|now|this|since|because|as|so|and|but|at|with|anyway|either|too';
