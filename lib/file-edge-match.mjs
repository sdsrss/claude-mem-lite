 ...
 *
 * THE only copy in the repo, for the same reason basenameAnySep is: the two legs of
 * that hook escape for the same ESCAPE clause, and the one that had its own copy is
