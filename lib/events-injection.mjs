 ...
 * their evidence. The section had been injected 50 times (250 rows) into this project's
 ...
 * NOT evidence either way: only `activity get` bumps it, while `mem_get` / `get E#N` go
