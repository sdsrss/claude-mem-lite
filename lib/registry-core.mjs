...
/**
 * Whether the confinement gate is active. Only the exact string `off` disables it — an unset
 * or misspelled value keeps the gate ON, because the failure mode of a typo must be "refuses
 * a path it could have read", never "reads a path it should have refused".
 */
