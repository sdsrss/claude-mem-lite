 ...
 * An explicit `0` is honoured whenever the range admits it: the `|| DEFAULT`
 * idiom swallowed it, which is why knobs documented as "0 = disable" did not
 * disable (see CLAUDE_MEM_CITE_NUDGE_MIN_INJECTED).
 *
